<%--
    Document   : addMenu
    Created on : May 26, 2025, 10:14:03 PM
    Author     : User
--%>
...
<head>
    ...
    <title>Add Menu Item - LaparGila</title>
    ...
    <script>
        function validateForm() {
            var name = document.forms["menuForm"]["name"].value;
...
<div class="content">
    ...
    <form name="menuForm" action="AddMenuServlet" method="post" onsubmit="return validateForm()">
